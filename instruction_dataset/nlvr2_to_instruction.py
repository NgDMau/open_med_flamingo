...
question_answer_templates = [
    ...
    (
        "Does the description '{}' hold true?",
        ("Yes, it holds true.", "No, it doesn't hold true."),
    ),
    (
        "Can we confirm that '{}' is accurate?",
        ("Yes, we can confirm it's accurate.", "No, we cannot confirm it's accurate."),
    ),
    ("Is it true to say that '{}'", ("Yes, it's true.", "No, it's false.")),
    ("Is the assertion '{}' valid?", ("Yes, it's valid.", "No, it's invalid.")),
    (
        "Is the given information '{}' reliable?",
        ("Yes, it's reliable.", "No, it's unreliable."),
    ),
    (
        "Can we verify that '{}' is true?",
        ("Yes, we can verify it's true.", "No, we cannot verify it's true."),
    ),
    (
        "Is it correct to assume that '{}'",
        ("Yes, it's correct to assume that.", "No, it's incorrect to assume that."),
    ),
    (
        "Is the claim '{}' accurate?",
        ("Yes, the claim is accurate.", "No, the claim is inaccurate."),
    ),
    (
    ...
    (
        "Is '{}' a true statement?",
        ("Yes, it's a true statement.", "No, it's a false statement."),
    ),
    (
        "Is the sentence '{}' correct?",
        ("Yes, the sentence is correct.", "No, the sentence is incorrect."),
    ),
    ("Is it factual that '{}'", ("Yes, it's factual.", "No, it's not factual.")),
    (
        "Can we accept '{}' as true?",
        ("Yes, we can accept it as true.", "No, we cannot accept it as true."),
    ),
    (
        "Is there truth in the statement '{}'",
        (
            "Yes, there is truth in the statement.",
            "No, there is no truth in the statement.",
        ),
    ),
    (
        "Is the declaration '{}' true?",
        ("Yes, the declaration is true.", "No, the declaration is false."),
    ),
    (
        "Would you say '{}' is true?",
        ("Yes, I would say it's true.", "No, I would say it's false."),
    ),
    ("Is it the case that '{}'", ("Yes, it's the case.", "No, it's not the case.")),
    (
        "Is the following accurate: '{}'?",
        ("Yes, it's accurate.", "No, it's not accurate."),
    ),
    # Variations that start with the statement
    ("{}. Is that true?", ("Yes, that's true.", "No, that's not true.")),
    (
        "{}. Can we confirm this?",
        ("Yes, we can confirm this.", "No, we cannot confirm this."),
    ),
    ("{}. Is this accurate?", ("Yes, this is accurate.", "No, this is not accurate.")),
    (
        "{}. Is this statement correct?",
        ("Yes, this statement is correct.", "No, this statement is incorrect."),
    ),
    ...
    (
        "{}. Can we verify the truth?",
        ("Yes, we can verify the truth.", "No, we cannot verify the truth."),
    ),
    (
        "{}. Can we assume this?",
        ("Yes, we can assume this.", "No, we cannot assume this."),
    ),
    (
        "{}. Is this claim accurate?",
        ("Yes, this claim is accurate.", "No, this claim is not accurate."),
    ),
    ("{}. True or false?", ("True.", "False.")),
    (
        "{}. Is this a true statement?",
        ("Yes, this is a true statement.", "No, this is a false statement."),
    ),
    (
        "{}. Is this sentence correct?",
        ("Yes, this sentence is correct.", "No, this sentence is not correct."),
    ),
    ("{}. Is it factual?", ("Yes, it's factual.", "No, it's not factual.")),
    (
        "{}. Can we accept this as true?",
        ("Yes, we can accept this as true.", "No, we cannot accept this as true."),
    ),
    (
        "{}. Is there truth in this statement?",
        (
            "Yes, there is truth in this statement.",
            "No, there is no truth in this statement.",
        ),
    ),
    (
        "{}. Is the declaration true?",
        ("Yes, the declaration is true.", "No, the declaration is not true."),
    ),
    (
        "{}. Would you say this is true?",
        ("Yes, I would say this is true.", "No, I would say this is not true."),
    ),
    ("{}. Is it the case?", ("Yes, it's the case.", "No, it's not the case.")),
    (
        "{}. Is the following accurate?",
        ("Yes, the following is accurate.", "No, the following is not accurate."),
    ),
]
...
right_image_identifier = identifier_templates[1][
    identifier_templates[0].index(left_image_identifier)
]
...
def convert_data_to_new_format(data):
    ...
    for example in data:
        ...
        question_template, (positive_answer_template, negative_answer_template) = (
            random.choice(question_answer_templates)
        )
        ...
        output = (
            positive_answer_template
            if example["label"] == "True"
            else negative_answer_template
        )
        ...
        converted_example = {"input": instruction, "output": output}
...
if __name__ == "__main__":
    ...
    for dataset, info in data_info.items():
        ...
        for example in data:
            left_image_path, right_image_path = get_local_image_paths(
                example, info["image_base_path"]
            )
