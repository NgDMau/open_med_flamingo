...
def llava_to_instruction(input_filename, output_filename):
    ...
    for item in input_data:
        ...
        output_data.append({"input": instruction, "output": output})
...
if __name__ == "__main__":
    ...
    llava_to_instruction(
        "/cpfs/user/chendelong/instruction_tuning_dataset/WizardLM_evol_instruct_V2_143k.json",
        "converted_datasets/WizardLM_evol_instruct_V2_143k.json",
    )
