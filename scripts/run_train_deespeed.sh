...
CUDA_VISIBLE_DEVICES='0,1,2,3,4,5,6,7' accelerate launch --num_processes 4 open_flamingo/instruction_tuning/train.py \
    ...
    --tuning_config '/app/baseline_models/instruct_flamingo/open_flamingo/instruction_tuning/tuning_config/sft.json' \
