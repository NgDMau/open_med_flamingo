...
torchrun --nnodes=1 --nproc_per_node=1 train/train.py \
    ...
    --train_num_samples 2 \
    --train_json_path "/home/mau_nguyen_dinh_caddi_jp/projects/dataset/vlm-project-with-images-with-bbox-images-v4/llava_med_mri_bbox_train_small_CoT_new.json" \
